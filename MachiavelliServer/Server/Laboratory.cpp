...
Laboratory::Laboratory() : BuildCard("Laboratory", 3, CardColor::PURPLE, "Once during your turn, you may discard a building card from your hand and receive one gold from the bank", true, false)
{
}

void Laboratory::UseCardSpecial(std::shared_ptr<GameManager> manager, std::shared_ptr<Player> player)
{
...
BuildingEnum Laboratory::GetType()
{
	return BuildingEnum::LABORATORY;
}
